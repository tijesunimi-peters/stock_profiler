...
export declare const STATUS_META: Record<MetricStatus, {
    glyph: string;
    tag: string;
    className: string;
    description: string;
...
export declare function isDrained(status: MetricStatus): boolean;
/**
 ...
 */
export declare function formatMetric(mv: Pick<MetricValue, "value" | "unit" | "status" | "display">): string;
