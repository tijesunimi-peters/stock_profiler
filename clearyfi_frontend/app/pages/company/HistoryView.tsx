...
export function HistoryView() {
  ...
  // Its own read, and deliberately a cheap one: the crumb needs the filer's own name and SIC.
  ...
  return (
    <div className="hub">
      <div className="hub-crumb">
        ...
        {/* The registrant name EDGAR holds. `FILER_BY_SYMBOL` was fourteen semiconductor
            tickers, so every other filer was headed by its ticker. */}
        <span className="hub-crumb-name">{basics.data?.name ?? T}</span>
