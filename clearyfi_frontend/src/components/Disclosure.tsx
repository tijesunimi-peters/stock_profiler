...
export const STANDARD_DISCLOSURES = {
  financials_floor:
    "XBRL financial data begins around 2009–2012 depending on filer size. An empty period means we have no structured data for it, not that nothing was filed.",
  institutional_13f:
    "13F reports quarter-end long positions only — no shorts, no derivatives — and is filed up to 45 days after quarter end. Any buy/sell is DERIVED by diffing consecutive quarters, never a reported trade.",
  ownership_13dg_floor:
    "Schedule 13D/13G is only available as structured XML from around mid-2025; earlier filings are not covered.",
  not_advice:
    "This is public SEC filing data, cleaned and re-shaped. It is not investment advice, and nothing here is a recommendation.",
} as const;
