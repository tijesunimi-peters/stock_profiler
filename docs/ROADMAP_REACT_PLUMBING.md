...
| # | Card | Band | Status |
|---|---|---|---|
| 7.1 | Legal proceedings — recorded accrual | ✅ **SHIPPED 2026-08-06** | **The 2026-08-04 ruling is OVERTURNED** — it kept the table as a marked fixture, judged on its shape. Looked at by content, the fixture invented three matters per company ("securities class action · on appeal · $214M") against a named issuer: a fabricated ALLEGATION, which the synthetic chip did not stop reading as data. The card now reports the one structured column, `loss_contingency_accrual` (**8.1% market-wide**, ~24% of established filers), and an explained absence otherwise. Matter/stage/age stay Item 3 narrative. |
