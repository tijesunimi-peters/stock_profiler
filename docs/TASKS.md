...
| OPS-4 | **`verify_deployment.py` passes against a stale database.** Add a row-count floor or a known-recent-filing assertion. | It returned 11/11 while production served a 13×-smaller pre-migration DB. | §5g |
